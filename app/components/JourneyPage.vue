...
<template>
  <article class="journal-sheet" :class="sheetClass">
    ...
    <div v-if="kind === 'cover'" class="journal-collage">
      <svg
        class="journal-doodle absolute top-[7%] right-[11%] w-[9cqw]"
        viewBox="0 0 100 100"
        fill="none"
        aria-hidden="true"
      >
      ...
      <svg
        class="journal-doodle absolute bottom-[9%] left-[6%] w-[7cqw] rotate-12"
        viewBox="0 0 100 100"
        fill="none"
        aria-hidden="true"
      >
      ...
      <div class="absolute top-[12%] left-[7%] w-[86%] -rotate-[1.5deg]">
        <span class="tape tape--top-left" style="--tape-tilt: -10deg; --tape-color: rgba(216, 230, 239, 0.85)" />
        <span class="tape tape--top-right" style="--tape-tilt: 10deg; --tape-color: rgba(249, 233, 168, 0.85)" />
        <div class="relative bg-paper-white px-[5cqw] pt-[5.5cqw] pb-[5cqw] shadow-paper-lift">
          <p class="font-mono text-[2.4cqw] font-semibold tracking-[0.34em] text-ink-faint uppercase">
            {{ t('journey.cover.label') }}
          </p>
          <p class="mt-[2.4cqw] font-hand text-[15cqw] leading-[0.9] font-bold text-emerald-deep">
            {{ t('journey.cover.title') }}
          </p>
          <p class="mt-[1.8cqw] font-hand text-[4.8cqw] leading-tight text-ink-soft">
            {{ t('journey.cover.subtitle') }}
          </p>
          <span class="mt-[3cqw] block h-[0.7cqw] w-[32cqw] -rotate-1 bg-note-yellow" aria-hidden="true" />
        </div>
      </div>

      <div class="absolute top-[56%] left-[8%] w-[42%]">
        <figure class="relative -rotate-[4deg]">
          <ThePaper color="white" class="journal-polaroid shadow-paper-lift">
            <span class="tape tape--top-center" style="--tape-tilt: -4deg" />
            <NuxtPicture
              ...
              format="avif,webp"
              legacy-format="webp"
              sizes="xs:120px sm:170px"
              loading="lazy"
              decoding="async"
              :img-attrs="{ class: 'h-full w-full object-cover', draggable: 'false' }"
            />
            <figcaption
              class="absolute inset-x-[3.4cqw] bottom-[2.4cqw] font-hand text-[4cqw] text-ink/80"
            >
      ...
      <div
        class="journal-stamp absolute top-[50%] right-[7%] text-[2.7cqw]"
        style="--stamp-color: #b8862b; --scrap-tilt: 9deg"
      >
        {{ t('journey.cover.started') }}
      </div>

      <div class="absolute right-[6%] bottom-[8%] w-[48%]">
        <ThePaper color="yellow" rotation="4deg" class="px-[4.6cqw] py-[4cqw]">
          <p class="font-hand text-[5cqw] leading-tight text-ink/85">
            {{ t('journey.cover.note') }}
          </p>
        </ThePaper>
      </div>
    </div>
